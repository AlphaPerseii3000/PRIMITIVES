...
[![Status: Concept/Alpha](https://img.shields.io/badge/Status-Concept%2FAlpha-orange.svg)](https://github.com/AlphaPerseii3000/PRIMITIVES)
...
-   **Engine:** [Three.js](https://threejs.org/) / WebGL for high-performance 3D rendering.
-   **Audio:** [Tone.js](https://tonejs.github.io/) / Web Audio API for procedural sound synthesis and sequencing.
...
**Author:** Jonathan (AlphaPerseii3000)
**Inspiration:** Osmos, Factorio, Rez, Tetris Effect.
